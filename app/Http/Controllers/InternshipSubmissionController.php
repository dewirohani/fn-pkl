...
class InternshipSubmissionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = Http::withHeaders([
            ...
            'ContentType' => 'application/json',
            'Accept' => 'application/json',
            ])->get('http://192.168.43.215:8000/api'.'/submissions')->json();
            // dd($data);
        ...
        if($request->ajax()){
            ...
            $data = Http::withHeaders([
                ...
                'ContentType' => 'application/json',
                'Accept' => 'application/json',
                ])->get('http://192.168.43.215:8000/api'.'/submission-students')->json();
                // dd($data);
    ...
    public function edit(Request $request, $id)
    {
        $data = Http::withHeaders([
            ...
            'ContentType' => 'application/json',
            'Accept' => 'application/json',
            ])->get('http://192.168.43.215:8000/api/submissions/'.$id.'/edit')->json();
            // dd($data);
        ...
        $dataStatuses = Http::withHeaders([
            ...
            'ContentType' => 'application/json',
            'Accept' => 'application/json',
            ])->get('http://192.168.43.215:8000/api/submissions-statuses')->json();
            // dd($data);
