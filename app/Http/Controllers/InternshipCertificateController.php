...
class InternshipCertificateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = Http::withHeaders([
            ...
            'ContentType' => 'application/json',
            'Accept' => 'application/json',
            ])->get('http://192.168.43.215:8000/api'.'/certificates')->json();
            // dd($data);
        ...
        if($request->ajax()){
            return DataTables::of($internship_certificate)
                            ...
                            ->addColumn('file', function($row){
                                $btnfile = '<a href="http://192.168.43.215:8000/'.$row->file.'" data-toggle="tooltip" data-original-title="View" class="edit btn btn-dark btn-sm"><span><i class="fas fa-download"></i></span></a>';
                                return $btnfile;
                            })
    ...
    public function show(Request $request, $id)
    {
        $data = Http::withHeaders([
            ...
            'ContentType' => 'application/json',
            'Accept' => 'application/json',
            ])->get('http://192.168.43.215:8000/api/certificates/'.$id)->json();
    ...
    public function edit(Request $request, $id)
    {
        $data = Http::withHeaders([
            ...
            'ContentType' => 'application/json',
            'Accept' => 'application/json',
            ])->get('http://192.168.43.215:8000/api/certificates/'.$id.'/edit')->json();
            $certificates = json_decode(json_encode($data))->certificates;       
