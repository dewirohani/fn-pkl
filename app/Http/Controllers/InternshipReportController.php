...
class InternshipReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = Http::withHeaders([
            ...
            'ContentType' => 'application/json',
            'Accept' => 'application/json',
            ])->get('http://192.168.43.215:8000/api'.'/reports')->json();            
    ...
    public function edit($id, Request $request)
    {
        ...
        $data = Http::withHeaders([
            ...
            'ContentType' => 'application/json',
            'Accept' => 'application/json',
            ])->get('http://192.168.43.215:8000/api/reports/'.$id.'/edit')->json();
            // dd($data);
            ...
            $dataStatuses = Http::withHeaders([
                ...
                'ContentType' => 'application/json',
                'Accept' => 'application/json',
                ])->get('http://192.168.43.215:8000/api/report-statuses')->json();
                // dd($dataStatuses);
