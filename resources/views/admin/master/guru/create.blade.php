                ...
                <div class="card">
                    ...
                    <div class="card-body">                     
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_guru" id="nama_guru" placeholder="ex: Jhon">
                            </div>                           
                            <div class="form-group">
                                <label>Alamat</label>
                                <input type="text" class="form-control" name="alamat_guru" id="alamat_guru" placeholder="ex: Jl.xxx">
                            </div>
                            <div class="form-group">
