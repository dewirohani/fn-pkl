...
@section('content')
    <div class="content">
        <div class="row">
            ...
            @include('guru.pkl.penempatan.scriptcreatedata')
            @include('guru.script.scriptgetjurusan')
            @include('guru.script.scriptgetkelas')
            @include('guru.script.scriptgetperiode')            
            @include('guru.script.scriptgetinstansi')            
